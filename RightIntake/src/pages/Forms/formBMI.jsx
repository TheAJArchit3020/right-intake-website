...
//               sm={12}
//               md={5}
//               className="bmi-ui-section1 d-flex flex-column align-items-center justify-content-center gap-2 text-center"
//             >
...
//                 <span className="bmi-status1 text-center w-100">
//                   Under Weight
//                 </span>
...
//                 <span className="bmi-category-name fw-bold">
//                   {bmiData?.status}
//                 </span>
//               </div>
//               <span className="bmi-description w-75 mt-5">
//                 {bmiData?.message}
//               </span>
//             </Col>
...
//                 <span className="bmi-motivation fw-bold">
//                   {bmiData?.additionalInfo?.motivationalText}
//                 </span>
//               </div>
//             </Col>
//           </Row>
